...
@rem You can also use JAVA_OPTS and SCAN_CLI_OPTS to pass JVM options to this script.
@rem The default JVM memory options can be changed by this mechanism.  Example: JAVA_OPTS=-Xms512m -Xmx4096m
@rem Finally, the packaged JRE can be overridden by setting BDS_JAVA_HOME
...
@rem Find java.exe
set JAVA_HOME=
if defined BDS_JAVA_HOME set JAVA_HOME=%BDS_JAVA_HOME%
...
echo.
echo ERROR: BDS_JAVA_HOME is set to an invalid directory: %JAVA_HOME%
echo.
echo Please unset BDS_JAVA_HOME to use the packaged version of Java or
echo set the BDS_JAVA_HOME variable in your environment to match the
echo location of your Java installation.
...
set CLASSPATH=%APP_HOME%\lib\scan.cli-2019.6.1-standalone.jar
